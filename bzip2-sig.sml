...
signature BZIP2 = sig
	(**
		This is raised when the Bzip2 library returns an error.
	...
	*)
	...
	(**
		Open a bzip2 file for reading and returns a text input stream.
		@params filename
		@param filename name of the file to open
	...
	*)
	...
	(**
		Opens a bzip2 file for writing
		@params filename
		@param filename name of the file to open
		@return text input stream
		@exception Failure, when the file can not be opened
